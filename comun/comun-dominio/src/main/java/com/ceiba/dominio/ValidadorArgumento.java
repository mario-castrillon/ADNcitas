...
public class ValidadorArgumento {
    ...
    public static void validarMayor(LocalDateTime fechaInicial, LocalDateTime fechaFinal, String mensaje) {
        if (fechaInicial.toLocalDate().isBefore(fechaFinal.toLocalDate())) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }
    
    public static void validarMenorHora(LocalDateTime horaInicial, LocalTime horaFinal, String mensaje) {
        if (horaInicial.toLocalTime().isBefore(horaFinal)) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }
    
    public static void validarMayorHora(LocalDateTime fechaInicial, LocalTime horaFinal, String mensaje) {
        if (fechaInicial.toLocalTime().isAfter(horaFinal)) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }
