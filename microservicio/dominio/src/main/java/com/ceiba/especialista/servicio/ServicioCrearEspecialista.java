...
public class ServicioCrearEspecialista {
	...
	private static final String EL_ESPECIALISTA_YA_EXISTE_EN_EL_SISTEMA =
									"El especialista ya existe en el sistema";
	...
	private void validarExistenciaPrevia(Especialista especialista) {
		boolean existe = this.repositorioEspecialista.existe(especialista.getNombreEspecialista());
		if(existe) {
