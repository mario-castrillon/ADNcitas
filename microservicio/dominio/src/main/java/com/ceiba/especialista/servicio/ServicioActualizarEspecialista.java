...
public class ServicioActualizarEspecialista {
	private static final String EL_ESPECIALISTA_NO_EXISTE_EN_EL_SISTEMA =
	...
	private void validarExistenciaPrevia(Especialista especialista) {
		boolean existe = this.repositorioEspecialista.existePorId(especialista.getIdEspecialista());
		if (!existe) {
